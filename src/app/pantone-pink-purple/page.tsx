...
import { pinkAndPurpleColors, type PantoneColor } from '@/lib/pantone-colors';
...
export default function PantonePinkPurplePage() {
  return (
    <div className="flex-1 w-full p-4 md:p-8">
      <CardHeader className="p-0 mb-8">
        <CardTitle className="text-3xl">Pantone Guide: Pinks & Purples</CardTitle>
        <CardDescription>A reference guide for Pantone colors in the pink and purple families.</CardDescription>
      </CardHeader>
