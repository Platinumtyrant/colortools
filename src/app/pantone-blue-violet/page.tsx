...
import { blueAndVioletColors, type PantoneColor } from '@/lib/pantone-colors';
...
export default function PantoneBlueVioletPage() {
  return (
    <div className="flex-1 w-full p-4 md:p-8">
      <CardHeader className="p-0 mb-8">
        <CardTitle className="text-3xl">Pantone Guide: Blues & Violets</CardTitle>
        <CardDescription>A reference guide for Pantone colors in the blue and violet families.</CardDescription>
      </CardHeader>
